...
import monti.com.firebasePetagram.presentador.IRecyclerViewFragmentPresentador;
import monti.com.firebasePetagram.presentador.RecyclerViewFragmentPresentador;
import monti.com.firebasePetagram.vistas.IRecyclerViewFragmentView;
...
/* ANTERIOR sin BD
  ...
  */
    ...
    public void generaGridLayout() {
        GridLayoutManager glm = new GridLayoutManager(this,2);
        listaFavoritas.setLayoutManager(glm);
    }
